...
*/}}
{{- define "pcns.configname" -}}
{{- if .Values.config.releaseScoped }}
{{- include "pcns.fullname" . }}
{{- else }}
{{- include "pcns.name" . }}
{{- end }}
{{- end }}
...
Selector labels
*/}}
{{- define "pcns.selectorLabels" -}}
app.kubernetes.io/name: {{ include "pcns.name" . }}
...
{{- default (include "pcns.fullname" .) .Values.serviceAccount.name }}
{{- else }}
