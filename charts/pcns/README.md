...
| database.clusterName | string | `"pcns"` | CrunchyDB PostgresCluster name |
| database.host | string | `"pcns-pgbouncer"` | Service used by application runtime connections |
...
| database.secretName | string | `"pcns-pguser-pcns"` | Application credentials; PGO-generated by default, overridden to pcns-pr-user for PRs |
