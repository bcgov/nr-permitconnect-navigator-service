...
// the template reads paths like `values.contact.firstName` with no optional
// chaining, which would throw if `values.contact` itself were missing. The
// real data replaces this via `resetForm()` once it loads (see
