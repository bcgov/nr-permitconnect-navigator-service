...
const oldMarker: Ref<L.Marker | undefined> = ref(undefined);
    ...
    map.on('pm:create', async (e) => {
      try {
        ...
        if (geo.toGeoJSON().geometry.type === POINT) {
          if (oldMarker.value) {
            map.removeLayer(oldMarker.value);
            oldMarker.value = undefined;
          }

          // const coords1 = e.marker._latlng;
          //@ts-ignore
          oldMarker.value = e.marker;
          // console.log(e.marker);
          // console.log(e.marker._latlng);
          // markers.value.push(coords1);
          // console.log('markers=== ' + JSON.stringify(markers.value));
          // removeAllMarkers(coords1);
          // setAddressMarker(coords1);
          //@ts-ignore
          ...
          console.log('polygon=== ' + JSON.stringify(geo.getLatLngs()[0]));
