...
const routes: RouteRecordRaw[] = [
  {
    ...
    meta: { access: [NavigationPermission.INT_GENERAL], requiresAuth: true },
    children: [
      {
        path: '',
        ...
        children: [
          ...
          },
          {
            ...
            children: [
              {
                path: '',
                name: RouteName.INT_GENERAL_ENQUIRY,
              ...
              },
              {
                ...
                children: [
                  {
                    path: ':noteHistoryId?',
                    name: RouteName.INT_GENERAL_ENQUIRY_NOTE,
            ...
            children: [
              ...
              },
              {
                ...
                children: [
                  {
                    path: ':noteHistoryId?',
                    name: RouteName.INT_GENERAL_PROJECT_NOTE,
                    component: () => import('@/views/internal/NoteView.vue'),
                    beforeEnter: accessHandler,
                    props: createProps
                  }
              ...
              },
              {
                ...
                children: [
                  {
                    path: '',
                    name: RouteName.INT_GENERAL_PROJECT_PROPONENT,
                  ...
                  {
                    path: ':permitId',
                    name: RouteName.INT_GENERAL_PROJECT_PROPONENT_PERMIT,
                    // TODO: Consider creating reuse component from view so we can create a separate internal view
      ...
      },
      {
        ...
        children: [
          {
            path: '',
            name: RouteName.INT_GENERAL_CONTACT,
            component: () => import('@/views/internal/ContactsView.vue'),
            beforeEnter: accessHandler
          },
          {
            path: ':contactId',
            name: RouteName.INT_GENERAL_CONTACT_PAGE,
      ...
      {
        path: 'user',
        name: RouteName.INT_GENERAL_USER_MANAGEMENT,
