      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            component: () => import('@/views/housing/enquiry/EnquiryIntakeConfirmationView.vue'),
            beforeEnter: accessHandler,
            props: createProps,
            meta: {
              access: [NavigationPermission.HOUSING_ENQUIRY_INTAKE],
        ...
        children: [
          {
            ...
            component: () => import('@/views/housing/intake/IntakeView.vue'),
            beforeEnter: accessHandler,
            props: createProps,
            meta: {
          ...
          },
          {
            ...
            component: () => import('@/views/housing/intake/IntakeConfirmationView.vue'),
            beforeEnter: accessHandler,
            props: createProps,
            meta: {
              hideBreadcrumb: true
