...
export enum RouteName {
  ...
  INT_ELECTRIFICATION_ENQUIRY_ADD_NOTE = 'int_electrification_enquiry_add_note',
  ...
  INT_ELECTRIFICATION_PROJECT_ADD_NOTE = 'int_electrification_project_add_note',
  ...
  INT_HOUSING_ENQUIRY_ADD_NOTE = 'int_housing_enquiry_add_note',
