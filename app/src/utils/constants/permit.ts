import { PeachItegratedSystems, PermitNeeded, PermitStage, PermitState } from '../enums/permit';

export const PEACH_INTEGRATED_SYSTEMS = [
  PeachItegratedSystems.ATS,
  PeachItegratedSystems.WMA,
  PeachItegratedSystems.VFCBC
];
