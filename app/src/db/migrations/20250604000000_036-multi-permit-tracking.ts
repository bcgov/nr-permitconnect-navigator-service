    ...
    knex.schema
      ...
      .then(() => {
        return knex('source_system_code').insert([
          ...
          },
          {
            ...
            acronym: 'WASTE' // TODO: Is this now AMS? But no ITSM # for new system
          },
          {
            code: 'ITSM-6197',
      ...
      .then(() => {
        return knex('source_system_kind').insert([
          ...
          // {
          //   description: '', // FTA - no names provided
          //   source_system_code: 'ITSM-5644'
          // },
          // {
          //   description: '', // MDS - no names provided
          ...
          // {
          //   description: '', // RRS - no names provided
