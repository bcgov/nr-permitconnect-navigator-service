    ...
    Promise.resolve()
      ...
      .then(() =>
        knex.schema.createTable('submission', (table) => {
          ...
          table.string('intakeStatus', 255);
          table.string('projectName', 255);
          table.string('queuePriority', 255);
          table.string('singleFamilyUnits', 255);
          table.string('streetAddress', 255);
          table.string('atsClientNumber', 255);
          table.boolean('addedToATS');
          table.boolean('financiallySupported');
          table.string('applicationStatus', 255);
