  ...
  (
    (
      (
        ...
        JOIN yars.attribute_group ON ((attribute_group.group_id = "group".group_id))
      )
      LEFT JOIN yars.policy_attribute ON (
        (
          (
            policy_attribute.policy_id = role_policy.policy_id
          )
          AND (
            policy_attribute.attribute_id = attribute_group.attribute_id
          )
        )
      )
    )
