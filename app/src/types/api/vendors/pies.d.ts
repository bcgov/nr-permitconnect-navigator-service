/**
 * This file was generated by nr-peach
 * @see https://github.com/bcgov/nr-peach/blob/main/src/types/elements.d.ts
 * Required manual changes:
 * 1. type Permit and Project need to be changed to PiesPermit and PiesProject to avoid conflicts with PCNS' types
 */

/**
 * Represents a message envelope for transmitting asset records.
 */
export type PiesRecord = Header & PiesPermit;
/**
...
export type PiesProject = Collection & Record<string, unknown>;
